...
| 分类 | 标准 |
|------|------|
| 正面 | 表达推荐、满意、成果展示、品牌认可、用户感谢 |
| 负面 | 表达不满、避雷、投诉、质疑、负面对比 |
| 中性 | 纯信息传递、提问、客观描述、无明显倾向 |

> **注意事项**：
> - 官方宣传帖（品牌自发内容）归为**中性**，不算正面
> - 需结合上下文理解反讽、阴阳怪气等隐性负面
> - 标题党 / 争议性标题需看正文实际内容再判定
> - 评论情感仍由 analyze.py 关键词规则处理（量大，无需 AI）
